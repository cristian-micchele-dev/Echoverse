    ...
    <div className={`lp ${visible ? 'lp--visible' : ''}`} ref={lpRef}>
      ...
      <footer className="lp-footer">
        <div className="lp-container lp-footer__inner">
          ...
          <div className="lp-footer__dev">
            <span className="lp-footer__dev-label">Desarrollado por</span>
            <span className="lp-footer__dev-name">Cristian Micchele</span>
            <div className="lp-footer__dev-links">
              <a href="https://github.com/cristian-micchele-dev" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="lp-footer__dev-link">
              ...
              <a href="https://www.linkedin.com/in/cristianmicchele/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="lp-footer__dev-link">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
