...
- **Mistral AI** (`ministral-14b-2512` por defecto, configurable con `MISTRAL_MODEL`) vía REST con `fetch`
...
| `MISTRAL_MODEL` | backend | ❌ | Modelo a usar (default: `ministral-14b-2512`). En el tier gratuito, `mistral-small` tiene solo 20k tokens/min |
